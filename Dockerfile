...
LABEL org.opencontainers.image.title="semrel-plugin-generator-release-notes" \
      org.opencontainers.image.description="semrel plugin: generator-release-notes" \
      org.opencontainers.image.url="https://semrel.io" \
      org.opencontainers.image.source="https://github.com/SemRels/generator-release-notes" \
